(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $('<li/>').html($('<a id="MinutesTab" href="#Minutes" style="padding: 6px 16px;">分钟</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="HourlyTab" href="#Hourly" style="padding: 6px 16px;">小时</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="DailyTab" href="#Daily" style="padding: 6px 16px;">日</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="MonthlyTab" href="#Monthly" style="padding: 6px 16px;">月</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="WeeklyTab" href="#Weekly" style="padding: 6px 16px;">周</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="YearlyTab" href="#Yearly" style="padding: 6px 16px;">年</a>')).appendTo(topMenu);
