(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            var mainDiv = $("<div/>", { id: "CronGenMainDiv", style: "width:100%;height:420px;" });
            var topMenu = $("<ul/>", { "class": "nav nav-tabs", id: "CronGenTabs",style: "display: flex;justify-content: space-around;" });
            $('<li/>', { 'class': 'active' }).html($('<a id="SecondlyTab" href="#Secondly" style="padding: 6px 16px;">秒</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="MinutesTab" href="#Minutes" style="padding: 6px 16px;">Minute</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="HourlyTab" href="#Hourly" style="padding: 6px 16px;">Hour</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="DailyTab" href="#Daily" style="padding: 6px 16px;">Day</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="MonthlyTab" href="#Monthly" style="padding: 6px 16px;">Month</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="WeeklyTab" href="#Weekly" style="padding: 6px 16px;">Week</a>')).appendTo(topMenu);
            $('<li/>').html($('<a id="YearlyTab" href="#Yearly" style="padding: 6px 16px;">Year</a>')).appendTo(topMenu);
